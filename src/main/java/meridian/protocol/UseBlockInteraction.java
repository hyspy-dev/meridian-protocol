...
public class UseBlockInteraction extends SimpleBlockInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("UseBlockInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 43;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("UseBlockInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static UseBlockInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static UseBlockInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one UseBlockInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static UseBlockInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new UseBlockInteraction(
    ...
    public UseBlockInteraction clone() {
        UseBlockInteraction copy = new UseBlockInteraction();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UseBlockInteraction other)) return false;
