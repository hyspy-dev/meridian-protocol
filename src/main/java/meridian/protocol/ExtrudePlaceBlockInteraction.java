...
public class ExtrudePlaceBlockInteraction extends DragPlaceBlockInteraction {
    ...
    public ExtrudePlaceBlockInteraction(@Nonnull WaitForDataFrom waitForDataFrom, @Nullable InteractionEffects effects, float horizontalSpeedMultiplier, float runTime, @Nonnull InteractionItemChangeBehavior onItemChangeBehavior, @Nullable java.util.Map<GameMode, InteractionSettings> settings, @Nonnull InteractionRules rules, @Nullable int[] tags, @Nullable InteractionCameraSettings camera, int next, int failed, int forkInteractions, int maxBlocksPerTick, int maxBlocksPerGesture) {
        ...
        this.next = next;
        this.failed = failed;
        this.forkInteractions = forkInteractions;
        this.maxBlocksPerTick = maxBlocksPerTick;
        this.maxBlocksPerGesture = maxBlocksPerGesture;
    }

    public ExtrudePlaceBlockInteraction(@Nonnull ExtrudePlaceBlockInteraction other) {
        ...
        this.forkInteractions = other.forkInteractions;
        this.maxBlocksPerTick = other.maxBlocksPerTick;
        this.maxBlocksPerGesture = other.maxBlocksPerGesture;
    }
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("ExtrudePlaceBlockInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 54;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("ExtrudePlaceBlockInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 34, 54, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 38, 54, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 42, 54, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 46, 54, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 50, 54, "Camera")): null;
    }
    ...
    public static int getForkInteractions(MemorySegment mem) {
        return getForkInteractions(mem, 0);
    }
    
    public static int getForkInteractions(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 22);
    }
    
    public static int getMaxBlocksPerTick(MemorySegment mem) {
        return getMaxBlocksPerTick(mem, 0);
    }
    
    public static int getMaxBlocksPerTick(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 26);
    }
    
    public static int getMaxBlocksPerGesture(MemorySegment mem) {
        return getMaxBlocksPerGesture(mem, 0);
    }
    
    public static int getMaxBlocksPerGesture(MemorySegment mem, int offset) {
    ...
    public static ExtrudePlaceBlockInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static ExtrudePlaceBlockInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one ExtrudePlaceBlockInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static ExtrudePlaceBlockInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        if (hasSettings(mem, offset)) {
            ...
            requireSlot(mem, offset + 38, -1, "Settings");
        }
        
        InteractionRules v6;
        requireSlot(mem, offset + 42, varPos, "Rules");
        {
        ...
        if (hasTags(mem, offset)) {
            requireSlot(mem, offset + 46, varPos, "Tags");
            var off = varBase + varPos;
            var packed = VarInt.getWithLength(mem, off);
            if (packed == -1L) throw ProtocolException.invalidVarInt("Tags");
            var len = (int) packed;
            ...
            requireSlot(mem, offset + 46, -1, "Tags");
        }
        
        InteractionCameraSettings v8 = null;
        if (hasCamera(mem, offset)) {
            requireSlot(mem, offset + 50, varPos, "Camera");
            v8 = InteractionCameraSettings.toObject(mem, varBase + varPos, walkCursor);
            varPos = walkCursor.position - varBase;
        } else {
            requireSlot(mem, offset + 50, -1, "Camera");
        }
        var result = new ExtrudePlaceBlockInteraction(
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        mem.set(PacketIO.PROTO_INT, offset + 22, this.forkInteractions);
        mem.set(PacketIO.PROTO_INT, offset + 26, this.maxBlocksPerTick);
        mem.set(PacketIO.PROTO_INT, offset + 30, this.maxBlocksPerGesture);
    ...
    public ExtrudePlaceBlockInteraction clone() {
        ExtrudePlaceBlockInteraction copy = new ExtrudePlaceBlockInteraction();
        ...
        copy.forkInteractions = this.forkInteractions;
        copy.maxBlocksPerTick = this.maxBlocksPerTick;
        copy.maxBlocksPerGesture = this.maxBlocksPerGesture;
        return copy;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Integer.hashCode(forkInteractions);
        result = 31 * result + Integer.hashCode(maxBlocksPerTick);
        result = 31 * result + Integer.hashCode(maxBlocksPerGesture);
        return result;
    }
