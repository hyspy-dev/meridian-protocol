...
public class GroundedConditionInteraction extends SimpleInteraction {
    ...
    public GroundedConditionInteraction(@Nonnull GroundedConditionInteraction other) {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("GroundedConditionInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 46;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("GroundedConditionInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 30, 46, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 34, 46, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 38, 46, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static float getTolerance(MemorySegment mem) {
        return getTolerance(mem, 0);
    }
    
    public static float getTolerance(MemorySegment mem, int offset) {
        return PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 22), "Tolerance");
    }
    ...
    public static GroundedConditionInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static GroundedConditionInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one GroundedConditionInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static GroundedConditionInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new GroundedConditionInteraction(
            ...
            PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 22), "Tolerance")
        );
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        PacketIO.requireFinite(this.tolerance, "Tolerance"); mem.set(PacketIO.PROTO_FLOAT, offset + 22, this.tolerance);
    ...
    public GroundedConditionInteraction clone() {
        GroundedConditionInteraction copy = new GroundedConditionInteraction();
    ...
    public int hashCode() {
        ...
        result = 31 * result + Float.hashCode(tolerance);
        return result;
    }
