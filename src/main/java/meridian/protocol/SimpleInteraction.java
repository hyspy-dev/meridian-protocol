...
public class SimpleInteraction extends Interaction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("SimpleInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 42;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("SimpleInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static SimpleInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static SimpleInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one SimpleInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static SimpleInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new SimpleInteraction(
    ...
    public SimpleInteraction clone() {
        SimpleInteraction copy = new SimpleInteraction();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SimpleInteraction other)) return false;
