...
public class DragPlaceBlockInteraction extends SimpleInteraction {
    ...
    public int maxBlocksPerGesture;

    public DragPlaceBlockInteraction() {
    }
    ...
    public DragPlaceBlockInteraction(@Nonnull DragPlaceBlockInteraction other) {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("DragPlaceBlockInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 54;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("DragPlaceBlockInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static DragPlaceBlockInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static DragPlaceBlockInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one DragPlaceBlockInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static DragPlaceBlockInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new DragPlaceBlockInteraction(
    ...
    public DragPlaceBlockInteraction clone() {
        DragPlaceBlockInteraction copy = new DragPlaceBlockInteraction();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DragPlaceBlockInteraction other)) return false;
