...
public class UseEntityInteraction extends SimpleInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("UseEntityInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 42;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("UseEntityInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static UseEntityInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static UseEntityInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one UseEntityInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static UseEntityInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new UseEntityInteraction(
    ...
    public UseEntityInteraction clone() {
        UseEntityInteraction copy = new UseEntityInteraction();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UseEntityInteraction other)) return false;
