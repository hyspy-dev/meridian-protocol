...
public class DragEraseBlockInteraction extends DragPlaceBlockInteraction {
    ...
    public DragEraseBlockInteraction(@Nonnull DragEraseBlockInteraction other) {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("DragEraseBlockInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 54;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("DragEraseBlockInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static DragEraseBlockInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static DragEraseBlockInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one DragEraseBlockInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static DragEraseBlockInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new DragEraseBlockInteraction(
    ...
    public DragEraseBlockInteraction clone() {
        DragEraseBlockInteraction copy = new DragEraseBlockInteraction();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DragEraseBlockInteraction other)) return false;
