...
public class CooldownConditionInteraction extends SimpleInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("CooldownConditionInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 46;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("CooldownConditionInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static String getCooldownId(MemorySegment mem, int offset) {
        return PacketIO.readVarString("CooldownId", mem, offset + getValidatedOffset(mem, offset, 42, 46, "CooldownId"), 4096000);
    }
    ...
    public static CooldownConditionInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static CooldownConditionInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one CooldownConditionInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static CooldownConditionInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        String v11;
        requireSlot(mem, offset + 42, varPos, "CooldownId");
        {
            var off = varBase + varPos;
        ...
        var result = new CooldownConditionInteraction(
    ...
    size += PacketIO.stringSize(cooldownId);
