...
public class RemoveEntityInteraction extends SimpleInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("RemoveEntityInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 43;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("RemoveEntityInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionTarget getEntityTarget(MemorySegment mem, int offset) {
        return InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 22));
    }
    ...
    public static RemoveEntityInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static RemoveEntityInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one RemoveEntityInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static RemoveEntityInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new RemoveEntityInteraction(
    ...
    public RemoveEntityInteraction clone() {
        RemoveEntityInteraction copy = new RemoveEntityInteraction();
