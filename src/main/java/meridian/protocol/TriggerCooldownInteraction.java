...
public class TriggerCooldownInteraction extends SimpleInteraction {
    ...
    public TriggerCooldownInteraction(@Nonnull WaitForDataFrom waitForDataFrom, @Nullable InteractionEffects effects, float horizontalSpeedMultiplier, float runTime, @Nonnull InteractionItemChangeBehavior onItemChangeBehavior, @Nullable java.util.Map<GameMode, InteractionSettings> settings, @Nonnull InteractionRules rules, @Nullable int[] tags, @Nullable InteractionCameraSettings camera, int next, int failed, @Nullable InteractionCooldown cooldown, boolean useAbilityCooldown) {
        ...
        this.useAbilityCooldown = useAbilityCooldown;
    }
    ...
    public TriggerCooldownInteraction(@Nonnull TriggerCooldownInteraction other) {
        ...
        this.useAbilityCooldown = other.useAbilityCooldown;
    }
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("TriggerCooldownInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 47;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("TriggerCooldownInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionCooldown getCooldown(MemorySegment mem, int offset) {
        return hasCooldown(mem, offset) ? InteractionCooldown.toObject(mem, offset + getValidatedOffset(mem, offset, 43, 47, "Cooldown")): null;
    }
    
    public static boolean getUseAbilityCooldown(MemorySegment mem) {
        return getUseAbilityCooldown(mem, 0);
    }
    
    public static boolean getUseAbilityCooldown(MemorySegment mem, int offset) {
    ...
    public static TriggerCooldownInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static TriggerCooldownInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one TriggerCooldownInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static TriggerCooldownInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        InteractionCooldown v11 = null;
        if (hasCooldown(mem, offset)) {
            requireSlot(mem, offset + 43, varPos, "Cooldown");
            v11 = InteractionCooldown.toObject(mem, varBase + varPos, walkCursor);
            varPos = walkCursor.position - varBase;
        } else {
            requireSlot(mem, offset + 43, -1, "Cooldown");
        }
        var result = new TriggerCooldownInteraction(
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        if (this.cooldown != null) nullBits |= 0x10;
        ...
        mem.set(PacketIO.PROTO_BOOL, offset + 22, this.useAbilityCooldown);
    ...
    public TriggerCooldownInteraction clone() {
        ...
        copy.useAbilityCooldown = this.useAbilityCooldown;
        return copy;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Boolean.hashCode(useAbilityCooldown);
        return result;
    }
