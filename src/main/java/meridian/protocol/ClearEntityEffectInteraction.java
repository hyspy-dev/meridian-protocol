...
public class ClearEntityEffectInteraction extends SimpleInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("ClearEntityEffectInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 47;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("ClearEntityEffectInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionTarget getEntityTarget(MemorySegment mem, int offset) {
        return InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 26));
    }
    ...
    public static ClearEntityEffectInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static ClearEntityEffectInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one ClearEntityEffectInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static ClearEntityEffectInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new ClearEntityEffectInteraction(
            ...
            InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 26))
        );
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        mem.set(PacketIO.PROTO_INT, offset + 22, this.effectId);
        mem.set(PacketIO.PROTO_BYTE, offset + 26, (byte) this.entityTarget.getValue());
    ...
    public ClearEntityEffectInteraction clone() {
        ClearEntityEffectInteraction copy = new ClearEntityEffectInteraction();
    ...
    public int hashCode() {
        ...
        result = 31 * result + Integer.hashCode(effectId);
