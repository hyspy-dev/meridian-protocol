...
public class SurfaceDrawPlaceBlockInteraction extends DragPlaceBlockInteraction {
    ...
    public SurfaceDrawPlaceBlockInteraction() {
    }
    ...
    public SurfaceDrawPlaceBlockInteraction(@Nonnull SurfaceDrawPlaceBlockInteraction other) {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("SurfaceDrawPlaceBlockInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 54;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("SurfaceDrawPlaceBlockInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static SurfaceDrawPlaceBlockInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static SurfaceDrawPlaceBlockInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one SurfaceDrawPlaceBlockInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static SurfaceDrawPlaceBlockInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new SurfaceDrawPlaceBlockInteraction(
    ...
    public SurfaceDrawPlaceBlockInteraction clone() {
        SurfaceDrawPlaceBlockInteraction copy = new SurfaceDrawPlaceBlockInteraction();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SurfaceDrawPlaceBlockInteraction other)) return false;
