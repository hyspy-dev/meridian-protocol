...
public class MovementConditionInteraction extends SimpleInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("MovementConditionInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 74;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("MovementConditionInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 54, 74, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 58, 74, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 62, 74, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 66, 74, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 70, 74, "Camera")): null;
    }
    ...
    public static int getForward(MemorySegment mem) {
        return getForward(mem, 0);
    }
    
    public static int getForward(MemorySegment mem, int offset) {
    ...
    public static int getForwardLeft(MemorySegment mem) {
        return getForwardLeft(mem, 0);
    }
    
    public static int getForwardLeft(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 38);
    }
    
    public static int getForwardRight(MemorySegment mem) {
        return getForwardRight(mem, 0);
    }
    
    public static int getForwardRight(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 42);
    }
    
    public static int getBackLeft(MemorySegment mem) {
        return getBackLeft(mem, 0);
    }
    
    public static int getBackLeft(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 46);
    }
    
    public static int getBackRight(MemorySegment mem) {
        return getBackRight(mem, 0);
    }
    
    public static int getBackRight(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 50);
    }
    ...
    public static MovementConditionInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static MovementConditionInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one MovementConditionInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static MovementConditionInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        if (hasSettings(mem, offset)) {
            ...
            requireSlot(mem, offset + 58, -1, "Settings");
        }
        
        InteractionRules v6;
        requireSlot(mem, offset + 62, varPos, "Rules");
        {
        ...
        if (hasTags(mem, offset)) {
            requireSlot(mem, offset + 66, varPos, "Tags");
            var off = varBase + varPos;
            var packed = VarInt.getWithLength(mem, off);
            if (packed == -1L) throw ProtocolException.invalidVarInt("Tags");
            var len = (int) packed;
            ...
            requireSlot(mem, offset + 66, -1, "Tags");
        }
        
        InteractionCameraSettings v8 = null;
        if (hasCamera(mem, offset)) {
            requireSlot(mem, offset + 70, varPos, "Camera");
            v8 = InteractionCameraSettings.toObject(mem, varBase + varPos, walkCursor);
            varPos = walkCursor.position - varBase;
        } else {
            requireSlot(mem, offset + 70, -1, "Camera");
        }
        var result = new MovementConditionInteraction(
            ...
            mem.get(PacketIO.PROTO_INT, offset + 50)
        );
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        mem.set(PacketIO.PROTO_INT, offset + 22, this.forward);
        mem.set(PacketIO.PROTO_INT, offset + 26, this.back);
        mem.set(PacketIO.PROTO_INT, offset + 30, this.left);
        mem.set(PacketIO.PROTO_INT, offset + 34, this.right);
        mem.set(PacketIO.PROTO_INT, offset + 38, this.forwardLeft);
        mem.set(PacketIO.PROTO_INT, offset + 42, this.forwardRight);
        mem.set(PacketIO.PROTO_INT, offset + 46, this.backLeft);
        mem.set(PacketIO.PROTO_INT, offset + 50, this.backRight);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MovementConditionInteraction other)) return false;
        return java.util.Objects.equals(this.waitForDataFrom, other.waitForDataFrom) && java.util.Objects.equals(this.effects, other.effects) && this.horizontalSpeedMultiplier == other.horizontalSpeedMultiplier && this.runTime == other.runTime && java.util.Objects.equals(this.onItemChangeBehavior, other.onItemChangeBehavior) && java.util.Objects.equals(this.settings, other.settings) && java.util.Objects.equals(this.rules, other.rules) && java.util.Arrays.equals(this.tags, other.tags) && java.util.Objects.equals(this.camera, other.camera) && this.next == other.next && this.failed == other.failed && this.forward == other.forward && this.back == other.back && this.left == other.left && this.right == other.right && this.forwardLeft == other.forwardLeft && this.forwardRight == other.forwardRight && this.backLeft == other.backLeft && this.backRight == other.backRight;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Integer.hashCode(forward);
        result = 31 * result + Integer.hashCode(back);
        result = 31 * result + Integer.hashCode(left);
        result = 31 * result + Integer.hashCode(right);
        result = 31 * result + Integer.hashCode(forwardLeft);
        result = 31 * result + Integer.hashCode(forwardRight);
        result = 31 * result + Integer.hashCode(backLeft);
        result = 31 * result + Integer.hashCode(backRight);
        return result;
    }
