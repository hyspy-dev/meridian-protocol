...
public class IncrementCooldownInteraction extends SimpleInteraction {
    ...
    public IncrementCooldownInteraction(@Nonnull WaitForDataFrom waitForDataFrom, @Nullable InteractionEffects effects, float horizontalSpeedMultiplier, float runTime, @Nonnull InteractionItemChangeBehavior onItemChangeBehavior, @Nullable java.util.Map<GameMode, InteractionSettings> settings, @Nonnull InteractionRules rules, @Nullable int[] tags, @Nullable InteractionCameraSettings camera, int next, int failed, @Nullable String cooldownId, float cooldownIncrementTime, int cooldownIncrementCharge, float cooldownIncrementChargeTime, boolean cooldownIncrementInterrupt) {
        ...
        this.cooldownIncrementTime = cooldownIncrementTime;
        this.cooldownIncrementCharge = cooldownIncrementCharge;
        this.cooldownIncrementChargeTime = cooldownIncrementChargeTime;
        this.cooldownIncrementInterrupt = cooldownIncrementInterrupt;
    }
    ...
    public IncrementCooldownInteraction(@Nonnull IncrementCooldownInteraction other) {
        ...
        this.cooldownIncrementTime = other.cooldownIncrementTime;
        this.cooldownIncrementCharge = other.cooldownIncrementCharge;
        this.cooldownIncrementChargeTime = other.cooldownIncrementChargeTime;
        this.cooldownIncrementInterrupt = other.cooldownIncrementInterrupt;
    }
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("IncrementCooldownInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 59;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("IncrementCooldownInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 35, 59, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 39, 59, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 43, 59, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 47, 59, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 51, 59, "Camera")): null;
    }
    ...
    public static String getCooldownId(MemorySegment mem, int offset) {
        return hasCooldownId(mem, offset) ? PacketIO.readVarString("CooldownId", mem, offset + getValidatedOffset(mem, offset, 55, 59, "CooldownId"), 4096000): null;
    }
    
    public static float getCooldownIncrementTime(MemorySegment mem) {
        return getCooldownIncrementTime(mem, 0);
    }
    
    public static float getCooldownIncrementTime(MemorySegment mem, int offset) {
        return PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 22), "CooldownIncrementTime");
    }
    
    public static int getCooldownIncrementCharge(MemorySegment mem) {
        return getCooldownIncrementCharge(mem, 0);
    }
    
    public static int getCooldownIncrementCharge(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 26);
    }
    
    public static float getCooldownIncrementChargeTime(MemorySegment mem) {
        return getCooldownIncrementChargeTime(mem, 0);
    }
    
    public static float getCooldownIncrementChargeTime(MemorySegment mem, int offset) {
        return PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 30), "CooldownIncrementChargeTime");
    }
    
    public static boolean getCooldownIncrementInterrupt(MemorySegment mem) {
        return getCooldownIncrementInterrupt(mem, 0);
    }
    
    public static boolean getCooldownIncrementInterrupt(MemorySegment mem, int offset) {
    ...
    public static IncrementCooldownInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static IncrementCooldownInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one IncrementCooldownInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static IncrementCooldownInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        if (hasCooldownId(mem, offset)) {
            requireSlot(mem, offset + 55, varPos, "CooldownId");
            var off = varBase + varPos;
            var sp = VarInt.getWithLength(mem, off);
            v11 = PacketIO.readVarString("CooldownId", mem, off, 0, 4096000, sp);
            varPos += (int) sp + (int) (sp >>> 32);
        } else {
            requireSlot(mem, offset + 55, -1, "CooldownId");
        }
        var result = new IncrementCooldownInteraction(
            ...
            v11,
            PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 22), "CooldownIncrementTime"),
            mem.get(PacketIO.PROTO_INT, offset + 26),
            PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 30), "CooldownIncrementChargeTime"),
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        if (this.cooldownId != null) nullBits |= 0x10;
        ...
        PacketIO.requireFinite(this.cooldownIncrementTime, "CooldownIncrementTime"); mem.set(PacketIO.PROTO_FLOAT, offset + 22, this.cooldownIncrementTime);
        mem.set(PacketIO.PROTO_INT, offset + 26, this.cooldownIncrementCharge);
        PacketIO.requireFinite(this.cooldownIncrementChargeTime, "CooldownIncrementChargeTime"); mem.set(PacketIO.PROTO_FLOAT, offset + 30, this.cooldownIncrementChargeTime);
        mem.set(PacketIO.PROTO_BOOL, offset + 34, this.cooldownIncrementInterrupt);
    ...
    public IncrementCooldownInteraction clone() {
        IncrementCooldownInteraction copy = new IncrementCooldownInteraction();
        ...
        copy.cooldownIncrementTime = this.cooldownIncrementTime;
        copy.cooldownIncrementCharge = this.cooldownIncrementCharge;
        copy.cooldownIncrementChargeTime = this.cooldownIncrementChargeTime;
        copy.cooldownIncrementInterrupt = this.cooldownIncrementInterrupt;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof IncrementCooldownInteraction other)) return false;
        return java.util.Objects.equals(this.waitForDataFrom, other.waitForDataFrom) && java.util.Objects.equals(this.effects, other.effects) && this.horizontalSpeedMultiplier == other.horizontalSpeedMultiplier && this.runTime == other.runTime && java.util.Objects.equals(this.onItemChangeBehavior, other.onItemChangeBehavior) && java.util.Objects.equals(this.settings, other.settings) && java.util.Objects.equals(this.rules, other.rules) && java.util.Arrays.equals(this.tags, other.tags) && java.util.Objects.equals(this.camera, other.camera) && this.next == other.next && this.failed == other.failed && java.util.Objects.equals(this.cooldownId, other.cooldownId) && this.cooldownIncrementTime == other.cooldownIncrementTime && this.cooldownIncrementCharge == other.cooldownIncrementCharge && this.cooldownIncrementChargeTime == other.cooldownIncrementChargeTime && this.cooldownIncrementInterrupt == other.cooldownIncrementInterrupt;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Float.hashCode(cooldownIncrementTime);
        result = 31 * result + Integer.hashCode(cooldownIncrementCharge);
        result = 31 * result + Float.hashCode(cooldownIncrementChargeTime);
        result = 31 * result + Boolean.hashCode(cooldownIncrementInterrupt);
        return result;
    }
