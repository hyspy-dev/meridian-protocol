...
public class DurabilityConditionInteraction extends SimpleInteraction {
    ...
    public DurabilityConditionInteraction(@Nonnull DurabilityConditionInteraction other) {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("DurabilityConditionInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 48;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("DurabilityConditionInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 28, 48, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 32, 48, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 36, 48, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 40, 48, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 44, 48, "Camera")): null;
    }
    ...
    public static float getThreshold(MemorySegment mem, int offset) {
        return PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 22), "Threshold");
    }
    ...
    public static DurabilityConditionInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static DurabilityConditionInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one DurabilityConditionInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static DurabilityConditionInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new DurabilityConditionInteraction(
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        PacketIO.requireFinite(this.threshold, "Threshold"); mem.set(PacketIO.PROTO_FLOAT, offset + 22, this.threshold);
        mem.set(PacketIO.PROTO_BYTE, offset + 26, (byte) this.valueType.getValue());
        mem.set(PacketIO.PROTO_BYTE, offset + 27, (byte) this.operator.getValue());
    ...
    public DurabilityConditionInteraction clone() {
        DurabilityConditionInteraction copy = new DurabilityConditionInteraction();
    ...
    public int hashCode() {
        ...
        result = 31 * result + Float.hashCode(threshold);
        result = 31 * result + java.util.Objects.hashCode(valueType);
        result = 31 * result + java.util.Objects.hashCode(operator);
        return result;
    }
