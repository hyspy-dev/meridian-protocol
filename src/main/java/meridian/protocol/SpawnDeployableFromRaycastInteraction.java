...
public class SpawnDeployableFromRaycastInteraction extends SimpleInteraction {
    ...
    @Nonnull public DeployableConfig deployableConfig = new DeployableConfig();
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("SpawnDeployableFromRaycastInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 54;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("SpawnDeployableFromRaycastInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 26, 54, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 30, 54, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 34, 54, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 38, 54, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 42, 54, "Camera")): null;
    }
    ...
    public static DeployableConfig getDeployableConfig(MemorySegment mem) {
        return getDeployableConfig(mem, 0);
    }
    
    public static DeployableConfig getDeployableConfig(MemorySegment mem, int offset) {
        return DeployableConfig.toObject(mem, offset + getValidatedOffset(mem, offset, 46, 54, "DeployableConfig"));
    }
    ...
    public static float getMaxDistance(MemorySegment mem, int offset) {
        return PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 22), "MaxDistance");
    }
    ...
    public static java.util.Map<Integer, Float> getCosts(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 50, 54, "Costs");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static SpawnDeployableFromRaycastInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static SpawnDeployableFromRaycastInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one SpawnDeployableFromRaycastInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static SpawnDeployableFromRaycastInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        DeployableConfig v11;
        requireSlot(mem, offset + 46, varPos, "DeployableConfig");
        {
            v11 = DeployableConfig.toObject(mem, varBase + varPos, walkCursor);
            varPos = walkCursor.position - varBase;
        }
        
        java.util.Map<Integer, Float> v13 = null;
        if (hasCosts(mem, offset)) {
            requireSlot(mem, offset + 50, varPos, "Costs");
            var off = varBase + varPos;
            var packed = VarInt.getWithLength(mem, off);
            if (packed == -1L) throw ProtocolException.invalidVarInt("Costs");
            var len = (int) packed;
            ...
            requireSlot(mem, offset + 50, -1, "Costs");
        }
        var result = new SpawnDeployableFromRaycastInteraction(
            ...
            v11,
            PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 22), "MaxDistance"),
            v13
        );
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        PacketIO.requireFinite(this.maxDistance, "MaxDistance"); mem.set(PacketIO.PROTO_FLOAT, offset + 22, this.maxDistance);
        var varOffset = offset + 54;
        if (this.effects != null) {
            mem.set(PacketIO.PROTO_INT, offset + 26, varOffset - offset - 54);
        ...
        varOffset += this.deployableConfig.serialize(mem, varOffset);
        if (this.costs != null) {
    ...
    size += deployableConfig.computeSize();
    ...
    public SpawnDeployableFromRaycastInteraction clone() {
        ...
        copy.deployableConfig = this.deployableConfig.clone();
    ...
    public int hashCode() {
        ...
        result = 31 * result + java.util.Objects.hashCode(deployableConfig);
