...
public class AssetEditorDeleteDirectory implements Packet, ToServerPacket {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("AssetEditorDeleteDirectory", offset, (int) mem.byteSize());
        long needed = (long) offset + 5;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("AssetEditorDeleteDirectory", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static AssetEditorDeleteDirectory toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static AssetEditorDeleteDirectory toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one AssetEditorDeleteDirectory and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static AssetEditorDeleteDirectory toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new AssetEditorDeleteDirectory(
    ...
    public AssetEditorDeleteDirectory clone() {
        AssetEditorDeleteDirectory copy = new AssetEditorDeleteDirectory();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AssetEditorDeleteDirectory other)) return false;
