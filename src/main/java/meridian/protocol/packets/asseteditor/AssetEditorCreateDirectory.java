...
public class AssetEditorCreateDirectory implements Packet, ToServerPacket {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("AssetEditorCreateDirectory", offset, (int) mem.byteSize());
        long needed = (long) offset + 5;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("AssetEditorCreateDirectory", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static AssetEditorCreateDirectory toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static AssetEditorCreateDirectory toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one AssetEditorCreateDirectory and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static AssetEditorCreateDirectory toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new AssetEditorCreateDirectory(
    ...
    public AssetEditorCreateDirectory clone() {
        AssetEditorCreateDirectory copy = new AssetEditorCreateDirectory();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AssetEditorCreateDirectory other)) return false;
