...
public class PointToolCreateResponse implements Packet, ToClientPacket {
    public static final int PACKET_ID = 521;
    ...
    public PointToolCreateResponse() {
    }

    public PointToolCreateResponse(@Nonnull String pointId, @Nullable String[] pointIds) {
        this.pointId = pointId;
        this.pointIds = pointIds;
    }

    public PointToolCreateResponse(@Nonnull PointToolCreateResponse other) {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("PointToolCreateResponse", offset, (int) mem.byteSize());
        long needed = (long) offset + 9;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("PointToolCreateResponse", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static String getPointId(MemorySegment mem, int offset) {
        return PacketIO.readVarString("PointId", mem, offset + getValidatedOffset(mem, offset, 1, 9, "PointId"), 4096000);
    }
    ...
    public static PointToolCreateResponse toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static PointToolCreateResponse toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one PointToolCreateResponse and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static PointToolCreateResponse toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        // Checking the whole fixed block up front lets the JIT elide the per-field bound checks.
        requireBounds(mem, offset);
        var varBase = offset + 9;
        var varPos = 0;
        String v0;
        requireSlot(mem, offset + 1, varPos, "PointId");
        {
        ...
        var result = new PointToolCreateResponse(
            v0,
            v1
        );
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        byte nullBits;
        nullBits = 0;
        if (this.pointIds != null) nullBits |= 0x01;
...
size += VarInt.size(pointIds.length) + pointIdsSize;
    ...
    public PointToolCreateResponse clone() {
        PointToolCreateResponse copy = new PointToolCreateResponse();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PointToolCreateResponse other)) return false;
        return java.util.Objects.equals(this.pointId, other.pointId) && java.util.Arrays.equals(this.pointIds, other.pointIds);
    }

    @Override
    public int hashCode() {
        int result = 1;
        result = 31 * result + java.util.Objects.hashCode(pointId);
