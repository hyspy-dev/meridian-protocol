...
public class TriggerVolumeToolSetTargetTypes implements Packet, ToServerPacket {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("TriggerVolumeToolSetTargetTypes", offset, (int) mem.byteSize());
        long needed = (long) offset + 1;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("TriggerVolumeToolSetTargetTypes", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    /**
     * Decodes one TriggerVolumeToolSetTargetTypes and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static TriggerVolumeToolSetTargetTypes toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new TriggerVolumeToolSetTargetTypes(
            v0,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TriggerVolumeToolSetTargetTypes other)) return false;
        return java.util.Objects.equals(this.volumeId, other.volumeId) && this.targetTypes == other.targetTypes;
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(volumeId, targetTypes);
    }
