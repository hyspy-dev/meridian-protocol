...
public class TriggerVolumeToolSetColor implements Packet, ToServerPacket {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("TriggerVolumeToolSetColor", offset, (int) mem.byteSize());
        long needed = (long) offset + 12;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("TriggerVolumeToolSetColor", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static Vector3fc getColor(MemorySegment mem, int offset) {
        return PacketIO.requireFinite(PacketIO.readVector3f(mem, offset + 0), "Color");
    }
    ...
    /**
     * Decodes one TriggerVolumeToolSetColor and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static TriggerVolumeToolSetColor toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new TriggerVolumeToolSetColor(
            v0,
            PacketIO.requireFinite(PacketIO.readVector3f(mem, offset + 0), "Color")
        );
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        PacketIO.requireFinite(this.color, "Color"); PacketIO.writeVector3f(mem, offset + 0, this.color);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TriggerVolumeToolSetColor other)) return false;
        return java.util.Objects.equals(this.volumeId, other.volumeId) && java.util.Objects.equals(this.color, other.color);
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(volumeId, color);
    }
