...
public class BuilderToolStringArg {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("BuilderToolStringArg", offset, (int) mem.byteSize());
        long needed = (long) offset + 1;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("BuilderToolStringArg", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static BuilderToolStringArg toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static BuilderToolStringArg toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one BuilderToolStringArg and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static BuilderToolStringArg toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new BuilderToolStringArg(
            v0
        );
    ...
    public BuilderToolStringArg clone() {
        BuilderToolStringArg copy = new BuilderToolStringArg();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BuilderToolStringArg other)) return false;
