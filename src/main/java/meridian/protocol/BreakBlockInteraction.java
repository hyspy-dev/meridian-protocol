...
public class BreakBlockInteraction extends SimpleBlockInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("BreakBlockInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 43;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("BreakBlockInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 23, 43, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 27, 43, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 31, 43, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 35, 43, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 39, 43, "Camera")): null;
    }
    ...
    public static boolean getHarvest(MemorySegment mem) {
        return getHarvest(mem, 0);
    }
    
    public static boolean getHarvest(MemorySegment mem, int offset) {
        return (mem.get(PacketIO.PROTO_BYTE, offset + 22) & 0x02) != 0;
    }
    
    public static boolean getSoftOnly(MemorySegment mem) {
        return getSoftOnly(mem, 0);
    }
    
    public static boolean getSoftOnly(MemorySegment mem, int offset) {
    ...
    public static BreakBlockInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static BreakBlockInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one BreakBlockInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static BreakBlockInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        // Checking the whole fixed block up front lets the JIT elide the per-field bound checks.
        requireBounds(mem, offset);
        var varBase = offset + 43;
        var varPos = 0;
        ...
        var result = new BreakBlockInteraction(
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        byte boolBits0_0 = 0;
        if (this.useLatestTarget) boolBits0_0 |= 0x01;
        if (this.harvest) boolBits0_0 |= 0x02;
        if (this.softOnly) boolBits0_0 |= 0x04;
        mem.set(PacketIO.PROTO_BYTE, offset + 22 + 0, boolBits0_0);
        var varOffset = offset + 43;
    ...
    public int hashCode() {
        ...
        result = 31 * result + Boolean.hashCode(harvest);
        result = 31 * result + Boolean.hashCode(softOnly);
        return result;
    }
