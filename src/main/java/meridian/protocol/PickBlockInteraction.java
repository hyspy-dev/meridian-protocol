...
public class PickBlockInteraction extends SimpleBlockInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("PickBlockInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 43;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("PickBlockInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static PickBlockInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static PickBlockInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one PickBlockInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static PickBlockInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new PickBlockInteraction(
    ...
    public PickBlockInteraction clone() {
        PickBlockInteraction copy = new PickBlockInteraction();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PickBlockInteraction other)) return false;
