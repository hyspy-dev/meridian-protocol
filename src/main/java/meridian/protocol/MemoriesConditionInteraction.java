...
public class MemoriesConditionInteraction extends Interaction {
    ...
    @Nonnull public java.util.Map<Integer, Integer> memoriesNext = new java.util.HashMap<>();
    public int failed = Integer.MIN_VALUE;

    public MemoriesConditionInteraction() {
    }

    public MemoriesConditionInteraction(@Nonnull WaitForDataFrom waitForDataFrom, @Nullable InteractionEffects effects, float horizontalSpeedMultiplier, float runTime, @Nonnull InteractionItemChangeBehavior onItemChangeBehavior, @Nullable java.util.Map<GameMode, InteractionSettings> settings, @Nonnull InteractionRules rules, @Nullable int[] tags, @Nullable InteractionCameraSettings camera, @Nonnull java.util.Map<Integer, Integer> memoriesNext, int failed) {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("MemoriesConditionInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 42;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("MemoriesConditionInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 18, 42, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 22, 42, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 26, 42, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 30, 42, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 34, 42, "Camera")): null;
    }
    
    public static java.util.Map<Integer, Integer> getMemoriesNext(MemorySegment mem) {
        return getMemoriesNext(mem, 0);
    }
    
    public static java.util.Map<Integer, Integer> getMemoriesNext(MemorySegment mem, int offset) {
        var off = offset + getValidatedOffset(mem, offset, 38, 42, "MemoriesNext");
        var packed = VarInt.getWithLength(mem, off);
        if (packed == -1L) throw ProtocolException.invalidVarInt("MemoriesNext");
        var len = (int) packed;
        if (len > 4096000) throw ProtocolException.dictionaryTooLarge("MemoriesNext", len, 4096000);
        
        off += (int) (packed >>> 32);
        if (off + (long) len * 8 > mem.byteSize()) throw ProtocolException.bufferTooSmall("MemoriesNext", (int) java.lang.Math.min(off + (long) len * 8, Integer.MAX_VALUE), (int) mem.byteSize());
        ...
        for (var i = 0; i < len; i++) {
            ...
            var value = mem.get(PacketIO.PROTO_INT, off);
                off += 4;
            if (data.put(key, value) != null) {
                throw ProtocolException.duplicateKey("MemoriesNext", key);
            }
        }
        return data;
    }
    ...
    public static MemoriesConditionInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static MemoriesConditionInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one MemoriesConditionInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static MemoriesConditionInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        java.util.Map<Integer, Integer> v9;
        requireSlot(mem, offset + 38, varPos, "MemoriesNext");
        {
            var off = varBase + varPos;
            var packed = VarInt.getWithLength(mem, off);
            if (packed == -1L) throw ProtocolException.invalidVarInt("MemoriesNext");
        ...
        var result = new MemoriesConditionInteraction(
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        if (this.memoriesNext.size() > 4096000) throw ProtocolException.dictionaryTooLarge("MemoriesNext", memoriesNext.size(), 4096000);
        varOffset += VarInt.set(mem, varOffset, this.memoriesNext.size());
        for (var e : this.memoriesNext.entrySet()) {
    ...
    size += VarInt.size(memoriesNext.size()) + memoriesNext.size() * (4 + 4);

        return size;
    }

    public MemoriesConditionInteraction clone() {
        MemoriesConditionInteraction copy = new MemoriesConditionInteraction();
        ...
        copy.memoriesNext = new java.util.HashMap<>(this.memoriesNext);
    ...
    public int hashCode() {
        ...
        result = 31 * result + java.util.Objects.hashCode(memoriesNext);
