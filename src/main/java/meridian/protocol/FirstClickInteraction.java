...
public class FirstClickInteraction extends Interaction {
    ...
    public int click = Integer.MIN_VALUE;
    public int held = Integer.MIN_VALUE;
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("FirstClickInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 42;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("FirstClickInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 22, 42, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 26, 42, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 30, 42, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 34, 42, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 38, 42, "Camera")): null;
    }
    
    public static int getClick(MemorySegment mem) {
        return getClick(mem, 0);
    }
    
    public static int getClick(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 14);
    }
    
    public static int getHeld(MemorySegment mem) {
        return getHeld(mem, 0);
    }
    
    public static int getHeld(MemorySegment mem, int offset) {
    ...
    public static FirstClickInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static FirstClickInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one FirstClickInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static FirstClickInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new FirstClickInteraction(
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        mem.set(PacketIO.PROTO_INT, offset + 14, this.click);
        mem.set(PacketIO.PROTO_INT, offset + 18, this.held);
    ...
    public FirstClickInteraction clone() {
        FirstClickInteraction copy = new FirstClickInteraction();
    ...
    public int hashCode() {
        ...
        result = 31 * result + Integer.hashCode(click);
        result = 31 * result + Integer.hashCode(held);
        return result;
    }
