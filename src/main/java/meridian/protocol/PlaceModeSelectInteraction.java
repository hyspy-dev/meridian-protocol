...
public class PlaceModeSelectInteraction extends SimpleInteraction {
    ...
    public int defaultInteractions;
    public int replaceInteractions = Integer.MIN_VALUE;
    public int retypeInteractions = Integer.MIN_VALUE;
    public int extrudeInteractions = Integer.MIN_VALUE;
    public int surfaceDrawInteractions = Integer.MIN_VALUE;
    public int fastPlaceInteractions = Integer.MIN_VALUE;

    public PlaceModeSelectInteraction() {
    }

    public PlaceModeSelectInteraction(@Nonnull WaitForDataFrom waitForDataFrom, @Nullable InteractionEffects effects, float horizontalSpeedMultiplier, float runTime, @Nonnull InteractionItemChangeBehavior onItemChangeBehavior, @Nullable java.util.Map<GameMode, InteractionSettings> settings, @Nonnull InteractionRules rules, @Nullable int[] tags, @Nullable InteractionCameraSettings camera, int next, int failed, int defaultInteractions, int replaceInteractions, int retypeInteractions, int extrudeInteractions, int surfaceDrawInteractions, int fastPlaceInteractions) {
        ...
        this.replaceInteractions = replaceInteractions;
        this.retypeInteractions = retypeInteractions;
        this.extrudeInteractions = extrudeInteractions;
        this.surfaceDrawInteractions = surfaceDrawInteractions;
        this.fastPlaceInteractions = fastPlaceInteractions;
    }

    public PlaceModeSelectInteraction(@Nonnull PlaceModeSelectInteraction other) {
        ...
        this.defaultInteractions = other.defaultInteractions;
        this.replaceInteractions = other.replaceInteractions;
        this.retypeInteractions = other.retypeInteractions;
        this.extrudeInteractions = other.extrudeInteractions;
        this.surfaceDrawInteractions = other.surfaceDrawInteractions;
        this.fastPlaceInteractions = other.fastPlaceInteractions;
    }
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("PlaceModeSelectInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 66;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("PlaceModeSelectInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static InteractionEffects getEffects(MemorySegment mem, int offset) {
        return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 46, 66, "Effects")): null;
    }
    ...
    public static java.util.Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 50, 66, "Settings");
    ...
    public static InteractionRules getRules(MemorySegment mem, int offset) {
        return InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 54, 66, "Rules"));
    }
    ...
    public static int[] getTags(MemorySegment mem, int offset) {
        ...
        var off = offset + getValidatedOffset(mem, offset, 58, 66, "Tags");
        var packed = VarInt.getWithLength(mem, off);
    ...
    public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
        return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 62, 66, "Camera")): null;
    }
    ...
    public static int getDefaultInteractions(MemorySegment mem) {
        return getDefaultInteractions(mem, 0);
    }
    
    public static int getDefaultInteractions(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 22);
    }
    
    public static int getReplaceInteractions(MemorySegment mem) {
        return getReplaceInteractions(mem, 0);
    }
    
    public static int getReplaceInteractions(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 26);
    }
    
    public static int getRetypeInteractions(MemorySegment mem) {
        return getRetypeInteractions(mem, 0);
    }
    
    public static int getRetypeInteractions(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 30);
    }
    
    public static int getExtrudeInteractions(MemorySegment mem) {
        return getExtrudeInteractions(mem, 0);
    }
    
    public static int getExtrudeInteractions(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 34);
    }
    
    public static int getSurfaceDrawInteractions(MemorySegment mem) {
        return getSurfaceDrawInteractions(mem, 0);
    }
    
    public static int getSurfaceDrawInteractions(MemorySegment mem, int offset) {
        return mem.get(PacketIO.PROTO_INT, offset + 38);
    }
    
    public static int getFastPlaceInteractions(MemorySegment mem) {
        return getFastPlaceInteractions(mem, 0);
    }
    
    public static int getFastPlaceInteractions(MemorySegment mem, int offset) {
    ...
    public static PlaceModeSelectInteraction toObject(MemorySegment mem) {
        return toObject(mem, 0, null);
    }
    
    public static PlaceModeSelectInteraction toObject(MemorySegment mem, int offset) {
        return toObject(mem, offset, null);
    }
    
    /**
     * Decodes one PlaceModeSelectInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static PlaceModeSelectInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        // Checking the whole fixed block up front lets the JIT elide the per-field bound checks.
        requireBounds(mem, offset);
        var varBase = offset + 66;
        var varPos = 0;
        var walkCursor = cursor != null ? cursor : new ReadCursor();
        InteractionEffects v1 = null;
        if (hasEffects(mem, offset)) {
            requireSlot(mem, offset + 46, varPos, "Effects");
            v1 = InteractionEffects.toObject(mem, varBase + varPos, walkCursor);
            varPos = walkCursor.position - varBase;
        } else {
            requireSlot(mem, offset + 46, -1, "Effects");
        }
        
        java.util.Map<GameMode, InteractionSettings> v5 = null;
        if (hasSettings(mem, offset)) {
            requireSlot(mem, offset + 50, varPos, "Settings");
            ...
            requireSlot(mem, offset + 50, -1, "Settings");
        }
        
        InteractionRules v6;
        requireSlot(mem, offset + 54, varPos, "Rules");
        {
        ...
        if (hasTags(mem, offset)) {
            requireSlot(mem, offset + 58, varPos, "Tags");
            var off = varBase + varPos;
            var packed = VarInt.getWithLength(mem, off);
            if (packed == -1L) throw ProtocolException.invalidVarInt("Tags");
            var len = (int) packed;
            ...
            requireSlot(mem, offset + 58, -1, "Tags");
        }
        
        InteractionCameraSettings v8 = null;
        if (hasCamera(mem, offset)) {
            requireSlot(mem, offset + 62, varPos, "Camera");
            v8 = InteractionCameraSettings.toObject(mem, varBase + varPos, walkCursor);
            varPos = walkCursor.position - varBase;
        } else {
            requireSlot(mem, offset + 62, -1, "Camera");
        }
        var result = new PlaceModeSelectInteraction(
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        mem.set(PacketIO.PROTO_INT, offset + 22, this.defaultInteractions);
        mem.set(PacketIO.PROTO_INT, offset + 26, this.replaceInteractions);
        mem.set(PacketIO.PROTO_INT, offset + 30, this.retypeInteractions);
        mem.set(PacketIO.PROTO_INT, offset + 34, this.extrudeInteractions);
        mem.set(PacketIO.PROTO_INT, offset + 38, this.surfaceDrawInteractions);
        mem.set(PacketIO.PROTO_INT, offset + 42, this.fastPlaceInteractions);
        var varOffset = offset + 66;
        if (this.effects != null) {
            mem.set(PacketIO.PROTO_INT, offset + 46, varOffset - offset - 66);
            varOffset += this.effects.serialize(mem, varOffset);
        } else {
            mem.set(PacketIO.PROTO_INT, offset + 46, -1);
        }
        if (this.settings != null) {
            mem.set(PacketIO.PROTO_INT, offset + 50, varOffset - offset - 66);
        ...
        mem.set(PacketIO.PROTO_INT, offset + 54, varOffset - offset - 66);
        varOffset += this.rules.serialize(mem, varOffset);
        if (this.tags != null) {
            mem.set(PacketIO.PROTO_INT, offset + 58, varOffset - offset - 66);
        ...
        if (this.camera != null) {
            mem.set(PacketIO.PROTO_INT, offset + 62, varOffset - offset - 66);
    ...
    public PlaceModeSelectInteraction clone() {
        PlaceModeSelectInteraction copy = new PlaceModeSelectInteraction();
        ...
        copy.defaultInteractions = this.defaultInteractions;
        copy.replaceInteractions = this.replaceInteractions;
        copy.retypeInteractions = this.retypeInteractions;
        copy.extrudeInteractions = this.extrudeInteractions;
        copy.surfaceDrawInteractions = this.surfaceDrawInteractions;
        copy.fastPlaceInteractions = this.fastPlaceInteractions;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PlaceModeSelectInteraction other)) return false;
        return java.util.Objects.equals(this.waitForDataFrom, other.waitForDataFrom) && java.util.Objects.equals(this.effects, other.effects) && this.horizontalSpeedMultiplier == other.horizontalSpeedMultiplier && this.runTime == other.runTime && java.util.Objects.equals(this.onItemChangeBehavior, other.onItemChangeBehavior) && java.util.Objects.equals(this.settings, other.settings) && java.util.Objects.equals(this.rules, other.rules) && java.util.Arrays.equals(this.tags, other.tags) && java.util.Objects.equals(this.camera, other.camera) && this.next == other.next && this.failed == other.failed && this.defaultInteractions == other.defaultInteractions && this.replaceInteractions == other.replaceInteractions && this.retypeInteractions == other.retypeInteractions && this.extrudeInteractions == other.extrudeInteractions && this.surfaceDrawInteractions == other.surfaceDrawInteractions && this.fastPlaceInteractions == other.fastPlaceInteractions;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Integer.hashCode(defaultInteractions);
        result = 31 * result + Integer.hashCode(replaceInteractions);
        result = 31 * result + Integer.hashCode(retypeInteractions);
        result = 31 * result + Integer.hashCode(extrudeInteractions);
        result = 31 * result + Integer.hashCode(surfaceDrawInteractions);
        result = 31 * result + Integer.hashCode(fastPlaceInteractions);
        return result;
    }
