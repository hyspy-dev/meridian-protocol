...
public class CancelChainInteraction extends SimpleInteraction {
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("CancelChainInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 46;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("CancelChainInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static String getChainId(MemorySegment mem, int offset) {
        return PacketIO.readVarString("ChainId", mem, offset + getValidatedOffset(mem, offset, 42, 46, "ChainId"), 4096000);
    }
    ...
    /**
     * Decodes one CancelChainInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static CancelChainInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new CancelChainInteraction(
