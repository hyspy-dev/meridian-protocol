...
public class CameraInteraction extends SimpleInteraction {
    ...
    @Nonnull public CameraActionType cameraAction = CameraActionType.ForcePerspective;
    @Nonnull public CameraPerspectiveType cameraPerspective = CameraPerspectiveType.First;
    ...
    public static void requireBounds(MemorySegment mem, int offset) {
        if (offset < 0) throw ProtocolException.invalidOffset("CameraInteraction", offset, (int) mem.byteSize());
        long needed = (long) offset + 49;
        if (needed > mem.byteSize()) throw ProtocolException.bufferTooSmall("CameraInteraction", (int) java.lang.Math.min(needed, Integer.MAX_VALUE), (int) mem.byteSize());
    }
    ...
    public static CameraActionType getCameraAction(MemorySegment mem, int offset) {
        return CameraActionType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 22));
    }
    ...
    public static CameraPerspectiveType getCameraPerspective(MemorySegment mem, int offset) {
        return CameraPerspectiveType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 23));
    }
    ...
    public static float getCameraInteractionTime(MemorySegment mem, int offset) {
        return PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 25), "CameraInteractionTime");
    }
    ...
    /**
     * Decodes one CameraInteraction and reports the end of its encoding through the cursor.
     * The variable block is decoded in field order against a running position, and each
     * offset slot must name that position, so the fields decoded are the bytes walked.
     */
    public static CameraInteraction toObject(MemorySegment mem, int offset, @Nullable ReadCursor cursor) {
        ...
        var result = new CameraInteraction(
            ...
            CameraActionType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 22)),
            CameraPerspectiveType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 23)),
            mem.get(PacketIO.PROTO_BOOL, offset + 24),
            PacketIO.requireFinite(mem.get(PacketIO.PROTO_FLOAT, offset + 25), "CameraInteractionTime")
        );
    ...
    public int serialize(@Nonnull MemorySegment mem, int offset) {
        ...
        mem.set(PacketIO.PROTO_BYTE, offset + 22, (byte) this.cameraAction.getValue());
        mem.set(PacketIO.PROTO_BYTE, offset + 23, (byte) this.cameraPerspective.getValue());
        mem.set(PacketIO.PROTO_BOOL, offset + 24, this.cameraPersist);
        PacketIO.requireFinite(this.cameraInteractionTime, "CameraInteractionTime"); mem.set(PacketIO.PROTO_FLOAT, offset + 25, this.cameraInteractionTime);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CameraInteraction other)) return false;
        return java.util.Objects.equals(this.waitForDataFrom, other.waitForDataFrom) && java.util.Objects.equals(this.effects, other.effects) && this.horizontalSpeedMultiplier == other.horizontalSpeedMultiplier && this.runTime == other.runTime && java.util.Objects.equals(this.onItemChangeBehavior, other.onItemChangeBehavior) && java.util.Objects.equals(this.settings, other.settings) && java.util.Objects.equals(this.rules, other.rules) && java.util.Arrays.equals(this.tags, other.tags) && java.util.Objects.equals(this.camera, other.camera) && this.next == other.next && this.failed == other.failed && java.util.Objects.equals(this.cameraAction, other.cameraAction) && java.util.Objects.equals(this.cameraPerspective, other.cameraPerspective) && this.cameraPersist == other.cameraPersist && this.cameraInteractionTime == other.cameraInteractionTime;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + java.util.Objects.hashCode(cameraAction);
        result = 31 * result + java.util.Objects.hashCode(cameraPerspective);
        result = 31 * result + Boolean.hashCode(cameraPersist);
        result = 31 * result + Float.hashCode(cameraInteractionTime);
        return result;
    }
